...
function Signup() {
    ...
    async function onFormSubmit(e) {
        ...
        if (signupDetails.fullName.length < 5) {
            toast.error("Name should at least have 5 characters");
            return;
        }
        ...
        const toastId = toast.loading('Wait, Creating your account');
        ...
        if (response.meta.requestStatus === 'fulfilled') {
            ...
            toast.error(response.payload || "Failed creation", { id: toastId });
        }
        ...
        <HomeLayout>
            <div className="flex overflow-x-auto items-center justify-center h-[100vh]">
                <form onSubmit={onFormSubmit} noValidate className="flex flex-col justify-center gap-3 rounded-lg p-4 text-white">
                    ...
                    <p>
                        Already have an account? <Link to='/signin' className="text-yellow-800 hover:text-yellow-500">Login</Link>
                    </p>
                </form>
            </div>
        </HomeLayout>
